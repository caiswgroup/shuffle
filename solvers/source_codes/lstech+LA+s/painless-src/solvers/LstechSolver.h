...
// Some forward declatarations for Lstech
namespace Minisat
{
	class SimpSolver;
	class Lit;
...
/// Instance of a Lstech solver
class LstechSolver : public SolverInterface
{
public:
   void solverRelease();
   void addOriginClauses(pakissat *P, int v);
...
protected:
   ...
   friend Minisat::Lit cbkLstechImportUnit(void *);
